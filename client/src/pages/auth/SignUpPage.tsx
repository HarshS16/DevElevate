...
// Three.js Scene Component (Simplified for sign-up)
const ThreeScene = () => {
  ...
  useEffect(() => {
    ...
    // Create fewer, more subtle floating shapes for sign-up page
    const geometries = [
    ...
    const pointLight2 = new THREE.PointLight(0x8b5cf6, 0.6, 40)
    ...
    const animate = () => {
      ...
      meshes.forEach((mesh) => {
        ...
        mesh.position.y = mesh.userData.originalY + Math.sin(Date.now() * 0.001 * mesh.userData.speed) * 1.5
        mesh.position.x = mesh.userData.originalX + Math.cos(Date.now() * 0.0008 * mesh.userData.speed) * 1
      })
...
export function SignUpPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 text-white overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-md mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
              ...
              <span className="text-sm font-medium">Join DevElevate</span>
            </div>
            ...
            <p className="text-gray-300 text-lg">
              Create your account and accelerate your career
            </p>
          </div>
            ...
            <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl border border-white/20 p-8">
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-400">
                  ...
                  <Link to="/sign-in" className="font-semibold text-blue-400 hover:text-blue-300 transition-colors group">
                    Sign in
      ...
      {/* Bottom Stats Bar */}
      <div className="fixed bottom-0 left-0 right-0 bg-black/30 backdrop-blur-xl border-t border-white/10 py-4">
